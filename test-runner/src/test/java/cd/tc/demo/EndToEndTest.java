...
import cd.tc.demo.ext.eureka.Eureka;
import cd.tc.demo.ext.item.ItemInfo;
import cd.tc.demo.ext.item.ItemService;
import cd.tc.demo.ext.postgres.Postgres;
import cd.tc.demo.ext.redis.Redis;
import cd.tc.demo.ext.user.UserInfo;
import cd.tc.demo.ext.user.UserService;
